...
*Defined in [transaction.ts:82](https://github.com/nearprotocol/nearlib/blob/a0bd9b2/src.ts/transaction.ts#L82)*
...
*Defined in [transaction.ts:81](https://github.com/nearprotocol/nearlib/blob/a0bd9b2/src.ts/transaction.ts#L81)*
