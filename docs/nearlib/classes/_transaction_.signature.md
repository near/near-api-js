...
*Defined in [src.ts/transaction.ts:82](https://github.com/nearprotocol/nearlib/blob/06c3a45/src.ts/transaction.ts#L82)*
...
*Defined in [src.ts/transaction.ts:81](https://github.com/nearprotocol/nearlib/blob/06c3a45/src.ts/transaction.ts#L81)*
