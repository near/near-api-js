...
*Defined in [src.ts/transaction.ts:82](https://github.com/nearprotocol/nearlib/blob/2987fdb/src.ts/transaction.ts#L82)*
...
*Defined in [src.ts/transaction.ts:81](https://github.com/nearprotocol/nearlib/blob/2987fdb/src.ts/transaction.ts#L81)*
