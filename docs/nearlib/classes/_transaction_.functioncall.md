...
*Defined in [src.ts/transaction.ts:41](https://github.com/nearprotocol/nearlib/blob/bf1ce09/src.ts/transaction.ts#L41)*
...
• **gas**: *[BN](../modules/_utils_format_.md#const-bn)*
