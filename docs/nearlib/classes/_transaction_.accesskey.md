...
*Defined in [transaction.ts:25](https://github.com/nearprotocol/nearlib/blob/a0bd9b2/src.ts/transaction.ts#L25)*
...
*Defined in [transaction.ts:26](https://github.com/nearprotocol/nearlib/blob/a0bd9b2/src.ts/transaction.ts#L26)*
