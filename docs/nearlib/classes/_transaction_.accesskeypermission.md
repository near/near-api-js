...
*Defined in [transaction.ts:21](https://github.com/nearprotocol/nearlib/blob/cbaa79a/src.ts/transaction.ts#L21)*
...
*Defined in [transaction.ts:20](https://github.com/nearprotocol/nearlib/blob/cbaa79a/src.ts/transaction.ts#L20)*
