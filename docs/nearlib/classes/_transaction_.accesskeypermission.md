...
*Defined in [src.ts/transaction.ts:21](https://github.com/nearprotocol/nearlib/blob/2987fdb/src.ts/transaction.ts#L21)*
...
*Defined in [src.ts/transaction.ts:20](https://github.com/nearprotocol/nearlib/blob/2987fdb/src.ts/transaction.ts#L20)*
