...
*Defined in [transaction.ts:21](https://github.com/nearprotocol/nearlib/blob/f222a4e/src.ts/transaction.ts#L21)*
...
*Defined in [transaction.ts:20](https://github.com/nearprotocol/nearlib/blob/f222a4e/src.ts/transaction.ts#L20)*
