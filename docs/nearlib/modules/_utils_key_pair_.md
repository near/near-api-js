...
*Defined in [src.ts/utils/key_pair.ts:7](https://github.com/nearprotocol/nearlib/blob/06c3a45/src.ts/utils/key_pair.ts#L7)*
...
*Defined in [src.ts/utils/key_pair.ts:19](https://github.com/nearprotocol/nearlib/blob/06c3a45/src.ts/utils/key_pair.ts#L19)*
...
*Defined in [src.ts/utils/key_pair.ts:26](https://github.com/nearprotocol/nearlib/blob/06c3a45/src.ts/utils/key_pair.ts#L26)*
