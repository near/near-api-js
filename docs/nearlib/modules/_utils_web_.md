...
*Defined in [utils/web.ts:15](https://github.com/nearprotocol/nearlib/blob/bae5ebc/src.ts/utils/web.ts#L15)*
...
*Defined in [utils/web.ts:39](https://github.com/nearprotocol/nearlib/blob/bae5ebc/src.ts/utils/web.ts#L39)*
