...
*Defined in [utils/web.ts:14](https://github.com/nearprotocol/nearlib/blob/57ba3df/src.ts/utils/web.ts#L14)*
...
*Defined in [utils/web.ts:16](https://github.com/nearprotocol/nearlib/blob/57ba3df/src.ts/utils/web.ts#L16)*
