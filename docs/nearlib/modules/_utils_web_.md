...
*Defined in [src.ts/utils/web.ts:15](https://github.com/nearprotocol/nearlib/blob/a71bd4f/src.ts/utils/web.ts#L15)*
...
*Defined in [src.ts/utils/web.ts:39](https://github.com/nearprotocol/nearlib/blob/a71bd4f/src.ts/utils/web.ts#L39)*
