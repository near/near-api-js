...
*Defined in [src.ts/utils/web.ts:15](https://github.com/nearprotocol/nearlib/blob/2987fdb/src.ts/utils/web.ts#L15)*
...
*Defined in [src.ts/utils/web.ts:39](https://github.com/nearprotocol/nearlib/blob/2987fdb/src.ts/utils/web.ts#L39)*
