...
*Defined in [src.ts/key_stores/browser_local_storage_key_store.ts:6](https://github.com/nearprotocol/nearlib/blob/bf1ce09/src.ts/key_stores/browser_local_storage_key_store.ts#L6)*
