...
*Defined in [key_stores/browser_local_storage_key_store.ts:6](https://github.com/nearprotocol/nearlib/blob/cbaa79a/src.ts/key_stores/browser_local_storage_key_store.ts#L6)*
