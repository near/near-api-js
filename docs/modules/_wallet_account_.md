...
*Defined in [wallet-account.ts:10](https://github.com/nearprotocol/nearlib/blob/b6e94a8/src.ts/wallet-account.ts#L10)*
...
*Defined in [wallet-account.ts:8](https://github.com/nearprotocol/nearlib/blob/b6e94a8/src.ts/wallet-account.ts#L8)*
