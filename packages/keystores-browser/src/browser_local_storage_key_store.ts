...
export class BrowserLocalStorageKeyStore extends KeyStore {
    ...
    /**
     * Stores a {@link utils/key_pair!KeyPair | KeyPair} in local storage.
    ...
    /**
     * Gets a {@link utils/key_pair!KeyPair | KeyPair} from local storage
     * @param networkId The targeted network. (ex. default, betanet, etc…)
     * @param accountId The NEAR account tied to the key pair
    ...
    /**
     * Removes a {@link utils/key_pair!KeyPair | KeyPair} from local storage
     * @param networkId The targeted network. (ex. default, betanet, etc…)
     * @param accountId The NEAR account tied to the key pair
     */
