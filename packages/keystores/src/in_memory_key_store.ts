...
export class InMemoryKeyStore extends KeyStore {
    ...
    /**
     * Stores a {@link utils/key_pair!KeyPair | KeyPair} in in-memory storage item
    ...
    /**
     * Gets a {@link utils/key_pair!KeyPair | KeyPair} from in-memory storage
     * @param networkId The targeted network. (ex. default, betanet, etc…)
     * @param accountId The NEAR account tied to the key pair
    ...
    /**
     * Removes a {@link utils/key_pair!KeyPair | KeyPair} from in-memory storage
     * @param networkId The targeted network. (ex. default, betanet, etc…)
     * @param accountId The NEAR account tied to the key pair
     */
