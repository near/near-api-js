...
export class MergeKeyStore extends KeyStore {
    ...
    /**
     * Store a {@link utils/key_pair!KeyPair | KeyPair} to the first index of a key store array
    ...
    /**
     * Gets a {@link utils/key_pair!KeyPair | KeyPair} from the array of key stores
     * @param networkId The targeted network. (ex. default, betanet, etc…)
     * @param accountId The NEAR account tied to the key pair
    ...
    /**
     * Removes a {@link utils/key_pair!KeyPair | KeyPair} from the array of key stores
     * @param networkId The targeted network. (ex. default, betanet, etc…)
     * @param accountId The NEAR account tied to the key pair
     */
