...
import { PublicKey, keyToImplicitAddress } from '../src/index.js';

const implicitAddressCases = [
    {
        publicKey: 'ed25519:DcA2MzgpJbrUATQLLceocVckhhAqrkingax4oJ9kZ847',
        expected: 'bb4dc639b212e075a751685b26bdcea5920a504181ff2910e8549742127092a0',
    },
    {
    ...
    },
    {
        ...
        expected: '4da7e0f4096aaf2ce55e371657cd3089ba1e9f59f4d6e27bd02e472a16a61dc1',
    },
    {
    ...
    },
    {
        ...
        expected: '424156f9ae27087a5de6b42f44d7f96db75d73ff6f3b9aa45f4cbe1259234829',
    },
];
