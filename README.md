...
The e2e project is intentionally excluded from the workspace to ensure packages are installed as standalone builds.
...
4. `bun run changeset` to generate a changeset with a minor bump for the @near-js/utils package
