    ...
    async deleteUnconfirmedRequests() {
        ...
        for (const requestIdToDelete of request_ids) {
            ...
            try {
                ...
                logger_1.getLogger().debug('Attempt to delete an earlier request before 15 minutes failed. Will try again.');
            }
        }
    }
    // helpers
...
class Account2FA extends AccountMultisig {
    ...
    async deployMultisig(contractBytes) {
        ...
        logger_1.getLogger().debug('deploying multisig contract for', accountId);
    ...
    async disable(contractBytes) {
        ...
        logger_1.getLogger().debug('disabling 2fa for', accountId);
    ...
    async promptAndVerify() {
        ...
        try {
            ...
            logger_1.getLogger().warn('Error validating security code:', e);
