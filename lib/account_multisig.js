...
exports.AccountMultisig = exports.isAccountMultisig = exports.MULTISIG_CONTRACT_HASHES = exports.MULTISIG_CONFIRM_METHODS = exports.MULTISIG_VIEW_METHODS = exports.MULTISIG_CHANGE_METHODS = exports.MULTISIG_DEPOSIT = exports.MULTISIG_GAS = exports.MULTISIG_ALLOWANCE = exports.MULTISIG_STORAGE_KEY = void 0;
...
exports.MULTISIG_CONTRACT_HASHES = process.env.MULTISIG_CONTRACT_HASHES || [
...
********************************/
exports.isAccountMultisig = async (connection, accountId) => {
    const account = new account_1.Account(connection, accountId);
    const state = await account.state();
    return exports.MULTISIG_CONTRACT_HASHES.includes(state.code_hash);
};
;
