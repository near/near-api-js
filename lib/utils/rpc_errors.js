...
exports.getErrorTypeFromErrorMessage = exports.formatError = exports.parseRpcResultError = exports.parseRpcError = exports.ServerTransactionError = exports.ServerErrorContext = exports.ServerError = void 0;
...
class ServerErrorContext {
    constructor(transactionHash, errorPath) {
        this.transactionHash = transactionHash;
        this.errorPath = errorPath;
    }
}
exports.ServerErrorContext = ServerErrorContext;
...
function parseRpcError(errorObj) {
    ...
    const error = new ServerError(formatError(errorClassName, result), errorClassName, new ServerErrorContext(undefined, errorObj));
    Object.assign(error, result);
    return error;
}
exports.parseRpcError = parseRpcError;
function parseRpcResultError(result) {
...
exports.parseRpcResultError = parseRpcResultError;
