...
exports.getErrorTypeFromErrorMessage = exports.formatError = exports.parseRpcResultError = exports.parseRpcError = void 0;
...
function parseRpcError(errorObj) {
    ...
    const error = new ServerError(formatError(errorClassName, result), errorClassName, new errors_1.ErrorContext(undefined, errorObj));
