...
exports.ConnectedWalletAccountWithKeyManagement = exports.WalletConnectionWithKeyManagement = void 0;
const wallet_connection_1 = require("./wallet-connection");
const MULTISIG_HAS_METHOD = 'add_request_and_confirm';
const LOCAL_STORAGE_KEY_SUFFIX = '_wallet_auth_key';
class WalletConnectionWithKeyManagement extends wallet_connection_1.WalletConnection {
    /**
    ...
    constructor(near, appKeyPrefix, wallet) {
        ...
        super(near, appKeyPrefix, wallet); // NOTE: super called here for backward compatability
...
class ConnectedWalletAccountWithKeyManagement extends wallet_connection_1.ConnectedWalletAccount {
    /**
...
exports.ConnectedWalletAccountWithKeyManagement = ConnectedWalletAccountWithKeyManagement;
