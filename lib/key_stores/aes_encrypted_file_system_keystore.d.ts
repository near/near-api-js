...
/** @hidden */
export declare function readKeyFile(filename: string, password: string): Promise<[string, KeyPair]>;
/**
 ...
 * ```
 */
export declare class AESEncryptedFileSystemKeyStore extends KeyStore {
    /** @hidden */
