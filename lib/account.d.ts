...
import { Action, SignedTransaction, AccessKey } from './transaction';
...
export declare class Account {
     ...
     */
    functionCall({ contractId, methodName, args, gas, attachedDeposit, walletMeta, walletCallbackUrl, stringify, jsContract }: FunctionCallOptions): Promise<FinalExecutionOutcome>;
    /**
     ...
     * @returns {Promise<any>}
     */
    viewFunction(contractId: string, methodName: string, args?: any, { parse, stringify, jsContract, blockQuery }?: {
    ...
    hasDeployedContract(): Promise<boolean>;
}
/**
