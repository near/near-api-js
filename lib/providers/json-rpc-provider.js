...
class JsonRpcProvider extends provider_1.Provider {
    ...
    async txStatusReceipts(txHash, accountId) {
        if (typeof txHash === 'string') {
            return this.txStatusReceiptsString(txHash, accountId);
        }
        else {
            return this.txStatusReceiptsUint8Array(txHash, accountId);
        }
    }
    async txStatusReceiptsUint8Array(txHash, accountId) {
        return this.sendJsonRpc('EXPERIMENTAL_tx_status', [borsh_1.baseEncode(txHash), accountId]);
    }
    async txStatusReceiptsString(txHash, accountId) {
