...
class Account {
    ...
    async getAccountBalance() {
        ...
        const stateStaked = new bn_js_1.default(this._state.storage_usage).mul(costPerByte);
        const staked = new bn_js_1.default(this._state.locked);
        const totalBalance = new bn_js_1.default(this._state.amount).add(staked);
