...
class Account {
    ...
    async createTransaction(receiverId, actions) {
        ...
        return transaction_1.createTransaction(this.accountId, publicKey, receiverId, nonce, actions, borsh_1.baseDecode(blockHash));
    }
    /**
    ...
    async signTransaction(receiverId, actions) {
        return await transaction_1.signTransactionObject(await this.createTransaction(receiverId, actions), this.connection.signer, this.accountId, this.connection.networkId);
    }
    /**
