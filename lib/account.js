...
class Account {
    ...
    async retryTxResult(txHash, accountId) {
        ...
        throw new providers_1.TypedError(`Exceeded ${TX_STATUS_RETRY_NUMBER} status check attempts for transaction ${serialize_1.base_encode(txHash)}.`, 'RetriesExceeded', serialize_1.base_encode(txHash));
    }
    /**
    ...
    async signAndSendTransaction(receiverId, actions) {
        ...
        try {
            ...
            if (error.type === 'TimeoutError') {
                ...
                error.transactionHash = serialize_1.base_encode(txHash);
                throw error;
            }
        }
