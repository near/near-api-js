...
class Transaction {
    ...
    functionCall(methodName, args, { gas = constants_1.DEFAULT_FUNCTION_CALL_GAS, attachedDeposit = constants_1.ZERO_NEAR, } = {}) {
        this.actions.push(transaction_1.functionCall(methodName, args, gas, attachedDeposit));
        return this;
    }
    stake(amount, publicKey) {
        this.actions.push(transaction_1.stake(amount, key_pair_1.PublicKey.from(publicKey)));
        return this;
    }
    transfer(amount) {
    ...
    get transferAmount() {
        return this._transferAmount ?? constants_1.ZERO_NEAR;
    }
    signAndSend() {
