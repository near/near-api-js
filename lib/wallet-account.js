...
exports.ConnectedWalletAccountInjected = exports.WalletConnectionInjected = exports.ConnectedWalletAccountRedirect = exports.WalletConnectionRedirect = void 0;
/**
 ...
 * ```
 */
class WalletConnectionRedirect extends WalletConection {
    /**
...
class WalletConnectionInjected extends WalletConection {
    requestSignTransactions({ transactions, meta, callbackUrl }) {
        throw new Error('Method not implemented.');
    }
    requestSignIn({ contractId, methodNames, successUrl, failureUrl }) {
